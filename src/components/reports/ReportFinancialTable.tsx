      ...
      <div className="overflow-x-auto">
        <table className="w-full text-left text-xs">
          <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
            ...
            <tr className="hover:bg-gray-50/50 dark:hover:bg-gray-800/20">
              <td className="py-2.5 px-3 font-medium text-gray-500">Less: Uncollected Credit (Unpaid Sales / Receivables)</td>
            ...
            <tr className="bg-brand-50/40 dark:bg-brand-500/10 font-bold">
              ...
              <td className={`py-2.5 px-3 text-right font-mono ${report.grossProfit >= 0 ? "text-brand-700 dark:text-brand-300" : "text-rose-600 dark:text-rose-400"}`}>
            ...
            <tr className="hover:bg-gray-50/50 dark:hover:bg-gray-800/20">
              ...
              <td className={`py-2.5 px-3 text-right font-mono font-bold ${report.swapMargin >= 0 ? "text-emerald-600 dark:text-emerald-400" : "text-rose-600 dark:text-rose-400"}`}>
                {report.swapMargin >= 0 ? `+PKR ${report.swapMargin.toLocaleString()}` : `-PKR ${Math.abs(report.swapMargin).toLocaleString()}`}
              </td>
            </tr>
            <tr className="hover:bg-gray-50/50 dark:hover:bg-gray-800/20">
              <td className="py-2.5 px-3 font-semibold text-rose-600 dark:text-rose-400">Less: Total Operating Expenses (Rent, Bills, Salaries)</td>
              <td className="py-2.5 px-3 text-right font-mono font-bold text-rose-600 dark:text-rose-400">-PKR {report.totalExpenses.toLocaleString()}</td>
            </tr>
            <tr className="bg-gray-100 dark:bg-gray-800 font-bold text-sm">
              ...
              <td className={`py-3 px-3 text-right font-mono font-bold ${report.totalNetIncome >= 0 ? "text-emerald-600 dark:text-emerald-400" : "text-rose-600 dark:text-rose-400"}`}>
